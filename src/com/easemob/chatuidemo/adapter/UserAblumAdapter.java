 ...
 *
 */
public class UserAblumAdapter extends BaseAdapter {  
    ...
    // 自己定义的构造函数  
    public UserAblumAdapter(Context context, List<Map<String, Object>> mListData, File cache) {  
        this.context = context;  
        this.Infos = mListData;  
        this.cache = cache;  
    ...
    public View getView(int position, View convertView, ViewGroup parent) {  
        ...
        if (convertView != null) {  
            ...
            view = mInflater.inflate(R.layout.row_user_photo, null);  
        }  
        ...
        Map<String, Object> info = Infos.get(position);  
  
        tv_content.setText(info.get("content").toString());
        tv_comment.setText("评论"+info.get("comment_num").toString()+"条");
        tv_date.setText(info.get("date").toString());
        // 异步的加载图片 (线程池 + Handler ) ---> AsyncTask  
        asyncloadImage(iv_header, info.get("skin").toString()); 
