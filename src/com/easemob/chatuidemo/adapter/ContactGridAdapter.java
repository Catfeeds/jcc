 ...
 *
 */
public class ContactGridAdapter extends ArrayAdapter<User>  implements SectionIndexer{
	...
	public ContactGridAdapter(Context context, int resource, List<User> objects) {
		super(context, resource, objects);
        System.out.println("user1:"+objects);
		this.res = resource;
...
//			    holder.unreadMsgView.setText(user.getUnreadMsgCount()+"");
			...
			holder.nameTextview.setText(user.getNick());
			holder.avatar.setImageResource(R.drawable.groups_icon);
		}else if(username.equals("item_add_user")){            
