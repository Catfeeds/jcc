...
public class TalentAdapter extends BaseAdapter {  
    ...
    // 自己定义的构造函数  
    public TalentAdapter(Context context, List<Info> Infos, File cache) {  
    ...
    public View getView(int position, View convertView, ViewGroup parent) {  
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.row_talents, null);
            holder.iv_header = (ImageView) convertView.findViewById(R.id.photo);  
