...
public class TalentsCommentActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://"+getResources().getString(R.string.server)+"/mobile/comment.php?id="+id+"&user="+EMChatManager.getInstance().getCurrentUser();
        Open(url);
    }
