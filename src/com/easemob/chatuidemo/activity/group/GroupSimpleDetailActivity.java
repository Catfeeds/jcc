...
public class GroupSimpleDetailActivity extends BaseActivity {
    ...
    private TextView tv_menbers_numb;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_menbers_numb = (TextView) findViewById(R.id.menbers_number);
		...
		Log.e("groupInfo","groupInfo="+groupInfo);
...
//		getResources().getString(R.string)
     ...
     private void showGroupDetail() {
         ...
         tv_menbers_numb.setText(group.getAffiliationsCount()+"人");
