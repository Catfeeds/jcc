...
public class ActionSheet {
	...
	public static Dialog showSheet(Context context,
		...
		TextView luzhi_shipin=(TextView) layout.findViewById(R.id.luzhi_shipin);//视频本地选择
		TextView choose_local_shipin=(TextView) layout.findViewById(R.id.choose_local_shipin);//录制视频
		if (type.equals("1")) {
			...
			luzhi_shipin.setVisibility(View.GONE);
			choose_local_shipin.setVisibility(View.GONE);
			...
			choose_local.setVisibility(View.GONE);
			delete_pic.setVisibility(View.GONE);
			luzhi_shipin.setVisibility(View.VISIBLE);
			choose_local_shipin.setVisibility(View.VISIBLE);
		}
		//录制视频
		luzhi_shipin.setOnClickListener(new OnClickListener() {
		...
		//调用本地视频
		choose_local_shipin.setOnClickListener(new OnClickListener() {
