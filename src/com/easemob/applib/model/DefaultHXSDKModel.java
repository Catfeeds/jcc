...
public class DefaultHXSDKModel extends HXSDKModel{
    ...
    public boolean saveIdentity(int identity) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.edit().putInt(PREF_IDENTITY, identity).commit();
    }

    @Override
    public int getIdentity() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.getInt(PREF_IDENTITY, 0);
    }

    @Override
    public boolean saveTutorial(int tutorial) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.edit().putInt(PREF_TUTORIAL, tutorial).commit();
    }

    @Override
    public int getTutorial() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        return preferences.getInt(PREF_TUTORIAL, 0);
    }
